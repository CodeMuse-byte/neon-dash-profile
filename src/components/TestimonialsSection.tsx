...
const TestimonialsSection = () => {
  ...
  return (
    <section id="testimonials" className="py-20 relative">
      <div className="absolute inset-0 bg-gradient-to-b from-background to-card/5" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div 
              key={testimonial.id}
              className="cyber-border bg-card/20 backdrop-blur-sm rounded-lg p-6 hover:scale-105 transition-all duration-300"
              data-aos="fade-up" 
        ...
        <div className="text-center mt-12" data-aos="fade-up" data-aos-delay="600">
          <div className="cyber-border bg-card/10 backdrop-blur-sm rounded-lg p-8 max-w-2xl mx-auto">
            ...
            <button 
              ...
              className="px-8 py-3 bg-gradient-to-r from-primary to-secondary text-primary-foreground rounded-lg font-rajdhani font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/30"
            >
              Get In Touch
            </button>
          </div>
